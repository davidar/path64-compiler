...
if(GXX_RUNTIME_OUTPUT AND GXX_RUNTIME_RESULT)
	...
	foreach(stripped_dir ${stripped_dirs_list})
		if(EXISTS "${stripped_dir}/libsupc++${CMAKE_STATIC_LIBRARY_SUFFIX}")
			set(CONFIGURED_LIBSUPCXX_DIR ${stripped_dir})
		endif()
		if(EXISTS "${stripped_dir}/libstdc++${CMAKE_STATIC_LIBRARY_SUFFIX}")
			set(CONFIGURED_LIBSTDCXX_DIR ${stripped_dir})
		endif()
		if(EXISTS "${stripped_dir}/libgcc${CMAKE_STATIC_LIBRARY_SUFFIX}")
			set(CONFIGURED_LIBGCC_DIR ${stripped_dir})
		endif()
		if(EXISTS "${stripped_dir}/libgcc_eh${CMAKE_STATIC_LIBRARY_SUFFIX}")
			set(CONFIGURED_LIBGCC_EH_DIR ${stripped_dir})
		endif()
		if(EXISTS "${stripped_dir}/libgcc_s${CMAKE_SHARED_LIBRARY_SUFFIX}")
